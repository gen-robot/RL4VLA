...
class FinetuneConfig:
    ...
    # Logging
    wandb_entity: str = "2200013163-peking-university"          # Name of WandB entity
    wandb_project: str = "rl4vla-oft"        # Name of WandB project
...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    if cfg.use_val_set:
        val_dataset = RLDSDataset(
            ...
            batch_transform,
            resize_resolution=tuple(vla.module.config.image_sizes),
            shuffle_buffer_size=cfg.shuffle_buffer_size // 100,
            image_aug=cfg.image_aug,
            train=False,
            unnorm_stats=unnorm_stats
        )
    ...
    with tqdm.tqdm(total=cfg.max_steps, leave=False) as progress:
        ...
        for batch_idx, batch in tqdm.tqdm(enumerate(dataloader), desc="training"):
            ...
            if gradient_step_idx % cfg.eval_steps == 0 or gradient_step_idx == cfg.max_steps:
                ...
                for eval_idx, eval_batch in enumerate(val_dataloader):
                    # Break if evaluation time limit is reached
